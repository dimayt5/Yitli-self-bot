...
`{prefix}avatar` - Аватарка пользователя. [Аргумент: Введите команду без упоминания или с упоминаем. (Например: `{prefix}avatar` (Без айди или упоминания, тогда в этом случае будет ваш аватар) (Айди пользователя или упоминание, тогда в этом случае будет аватарка пользователя)]
